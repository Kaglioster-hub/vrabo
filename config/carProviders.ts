export type CarProvider = {
  ...
  searchTemplate?: string; // usa {city},{pickup},{dropoff},{aff}
  affiliateEnv?: string;   // es. NEXT_PUBLIC_AFF_DISCOVERCARS
};

export const CAR_PROVIDERS: CarProvider[] = [
  // Aggregatori (deeplink completi)
  {
  ...
  // Brand diretti (di solito niente template unificato → si apre la home con UTM/ref)
