...
// 🔗 primo link valido tra NEXT_PUBLIC_AFF_ID_xxx*
function aff(type) {
...
export async function POST(req) {
  const t0 = Date.now();
  try {
    const { type = "bnb", query = "", startDate = "", endDate = "", profile = {}, limit = 12, currency = DEF_CUR } = await req.json();
