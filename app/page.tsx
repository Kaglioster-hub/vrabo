    ...
    <div className="min-h-screen bg-gray-100 dark:bg-black text-gray-900 dark:text-white flex flex-col">
        ...
        >
          ...
          <picture>
            ...
            <img
              ...
              loading="eager"
              decoding="async"
              className="mx-auto h-16 w-16 md:h-20 md:w-20 rounded-[22px] ring-1 ring-white/60 shadow-[0_0_20px_rgba(34,197,94,0.45)]"
            />
          </picture>
      ...
      <section id="about" className="py-20 text-center px-6 max-w-5xl mx-auto">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
          VRABO è un meta-comparatore che aggrega i migliori portali ufficiali di viaggi, finanza,
          servizi e molto altro. <br />
          Alcuni link sono affiliati: <b>per te nulla cambia</b>, ma ci permettono di mantenere il
          servizio gratuito, veloce e senza pubblicità invadente.
        </p>
      </section>
      ...
      <section id="newsletter" className="py-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white text-center px-6">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <button type="submit" className="px-6 py-3 bg-black rounded-lg font-semibold shadow hover:scale-105 transition">
              Iscriviti →
            </button>
          </form>
        </div>
      ...
      {/* Donazioni */}
      <section id="donazioni" className="py-20 text-center bg-gradient-to-r from-blue-900 via-purple-900 to-black text-white">
        <Donations />
      </section>
      ...
      <section id="contact" className="py-20 text-center px-6">
        ...
        <p className="mb-6 text-gray-600 dark:text-gray-300">Hai domande o vuoi collaborare con noi? Scrivici:</p>
        <a href="mailto:info@vrabo.it" className="px-8 py-3 bg-blue-600 rounded-lg text-lg font-semibold shadow-md text-white hover:scale-105 transition">
          Invia Email
        </a>
      </section>
