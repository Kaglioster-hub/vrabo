...
// Alias tipizzati per Framer Motion
const MotionDiv: React.ComponentType<
  React.HTMLAttributes<HTMLDivElement> & MotionProps
> = motion.div;

const MotionA: React.ComponentType<
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      ...
                      <span className="text-yellow-500 text-sm">
                        ⭐ {(r.rating ?? (3.5 + (i % 3) * 0.5)).toFixed
                          ? (r.rating as number).toFixed(1)
                          : (3.5 + (i % 3) * 0.5).toFixed(1)}
                      </span>
                    </div>
                  </div>
                </MotionA>
          ...
          <div className="mt-16 grid md:grid-cols-2 gap-8">
            ...
            <div className="chart-card">
              <h3 className="text-xl font-bold mb-6 text-center">
                📊 {t("priceDistribution") || "Distribuzione prezzi"}
              </h3>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart
                  data={results.map((r) => ({
                    name: (r.title || "").slice(0, 14) +
                      (r.title && r.title.length > 14 ? "…" : ""),
